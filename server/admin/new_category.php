...
if (isset($_POST['submit'])) {
    if (empty($_POST['c_name'])) {
        ...
        $stmt = $db->prepare("SELECT c_name FROM vendor_group WHERE c_name = :c_name");
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $insertStmt = $db->prepare("INSERT INTO vendor_group(c_name) VALUES(:c_name)");
            $insertStmt->execute([':c_name' => $_POST['c_name']]);
...
if (isset($_GET['cat_del'])) {
    $stmt = $db->prepare("DELETE FROM vendor_group WHERE c_id = :id");
    $stmt->execute([':id' => $_GET['cat_del']]);
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $stmt = $db->query("SELECT * FROM vendor_group ORDER BY c_id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="" method="get" style="display:inline;">
                                                        <input type="hidden" name="cat_del" value="' . $rows['c_id'] . '">
