    ...
    if (empty($d_name) || empty($about) || $price == '' || $res_name == '') {
        ...
        if (in_array($extension, ['jpg', 'png', 'gif'])) {
            if ($fsize >= 1000000) {
                ...
                $stmt = $db->prepare("INSERT INTO foods(rs_id, title, slogan, price, img) VALUES (:rs_id, :title, :slogan, :price, :img)");
                $stmt->execute([
                    ':rs_id' => $res_name,
                    ':title' => $d_name,
                    ':slogan' => $about,
                    ...
                    <div class="card card-outline-primary">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="res_name" class="form-control custom-select"
                                                    ...
                                                    <?php
                                                    $stmt = $db->query("SELECT * FROM vendor");
                        ...
                        <div class="form-actions">
                            <button type="submit" name="submit" class="btn btn-primary"><i class="fa fa-check"></i>
                                Save</button>
                            <a href="new_food.php" class="btn btn-inverse"><i class="fa fa-times"></i> Cancel</a>
                        </div>
                        </form>
                    </div>
                </div>
